...
* Develop new metrics and frameworks to measure portfolio managers’ performance in exposure mgmt., position sizing, timing, stock selection
* Internal consultant to portfolio managers/CIO to identify and quantify drivers of investment performance

**Data Analytics & Engineering** 

* Build analytics capabilities from zero, establishing data pipelines and lifecycle for analysis and data products for in-house use
* Lead R programmer for function libraries across data cleaning, transformation, visualisation, reporting and analysis
* Design, develop and deploy Tableau dashboards based on daily data (interactivity incl. Actions, Chart tooltips)
* Overhauled multiple reporting data pipelines, saving team 18 hours every month
